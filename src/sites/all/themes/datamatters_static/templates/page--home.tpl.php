  	...
  	<div id="wrapper">
			...
			<div class="main-content">
				...
				<div class="content">
					...
					<p id="homepage-slogan" class="slogan active">The Data-driven Policy Research projects from Central and Eastern Europe.<br />Using numbers and context to make the difference.<br><br><span>To read the story behind this portfolio please scroll down.</span></p>
